...
if(!isset($_GET['page'])||basename($_SERVER['REQUEST_URI'])=="about"|| basename($_SERVER['REQUEST_URI'])=="index" || basename($_SERVER['REQUEST_URI'])=="shop-left-sidebar" || basename($_SERVER['REQUEST_URI'])=="comptes"){
